...
public class OldClassifierAgent extends BasicMarioAIAgent implements Agent {
	static private final String name = "OldClassifierAgent::";
	...
	public OldClassifierAgent (Classifier c, DataSource inputData) {
	...
	private static FastVector setAttributes() {
		FastVector vec = new FastVector(12);
	...
	public boolean[] getAction() {
		...
		obs.setValue((Attribute)obs.attribute(14), isMarioOnGround?1:0); // mario_on_ground
		obs.setValue((Attribute)obs.attribute(15), isMarioAbleToJump?1:0); // mario_can_jump
